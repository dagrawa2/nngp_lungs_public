...
time_file = open("/raid/scratch/devanshu/innerprod_1024_times.txt", "w")

#skip = 100
print("loading data")
with h5py.File('/raid/ChestXRay14/chestxray14_1024.h5', 'r') as f:
    ...
    with h5py.File('/raid/scratch/devanshu/innerprods_1024.h5', 'w') as f:
