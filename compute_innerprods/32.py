...
time_file = open("/raid/scratch/devanshu/innerprod_32_times.txt", "w")

#skip = 100
print("loading data")
with h5py.File('/raid/ChestXRay14/chestxray14_32.h5', 'r') as f:
    ...
    with h5py.File('/raid/scratch/devanshu/innerprods_32.h5', 'w') as f:
