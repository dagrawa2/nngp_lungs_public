...
time_file = open("/raid/scratch/devanshu/innerprod_256_times.txt", "w")

#skip = 100
print("loading data")
with h5py.File('/raid/ChestXRay14/chestxray14_256.h5', 'r') as f:
    ...
    with h5py.File('/raid/scratch/devanshu/innerprods_256.h5', 'w') as f:
